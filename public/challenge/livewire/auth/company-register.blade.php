                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6 col-md-10 col-sm-12 mx-auto mt-lg-5">
                        ...
                        <div class="card wow fadeIn" data-wow-delay="0.3s">
                            <form action="{{route('company.register.post')}}" method="POST" style="font-size: .8rem">
                                @csrf
                                <div class="card-body right-aligned">
                                    ...
                                    <div class="md-form">
                                        <input type="password" name="password_confirmation" id="orangeForm-pass"
                                        ...
                                        @enderror
                                        <label for="orangeForm-pass">تایید رمز عبور</label>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <button class="btn blue-gradient btn-lg">ثبت نام</button>
                                        <hr>
