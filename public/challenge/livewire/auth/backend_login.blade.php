                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6 col-md-10 col-sm-12 mx-auto mt-lg-5">
                        ...
                        <div class="card wow fadeIn" data-wow-delay="0.3s">
                            <form action="{{route('backend.login')}}" method="POST" style="font-size: .8rem">
                                @csrf
                                <div class="card-body right-aligned">

                                    <!--Body-->
                                    <div class="md-form">
                                        <label for="orangeForm-name">نام</label>
                                        <input type="text" name="first_name" id="orangeForm-name" class="form-control  @error('first_name') is-invalid @enderror ">
                                        @error('first_name')
                                    ...
                                    <div class="md-form">
                                        <label for="orangeForm-name">نام خانوادگی</label>
                                        <input type="text" name="last_name" id="orangeForm-name" class="form-control  @error('last_name') is-invalid @enderror ">
                                        @error('last_name')
                                        <span class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
