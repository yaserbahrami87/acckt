                ...
                <div class="col-md-12 " >
                    ...
                    <div class="card ml-5" style="border-radius: 5px">
                        <div class="card-body " style="background-color: #fafafa;border-radius: 5px">
                            ...
                            <!--Section heading-->
                            <!--Grid column-->
                            <form id="delete_account_form" method="POST" action="{{route('profile.company.delete.account.post')}}" style="font-size: .8rem">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group text-right">
                                            ...
                                            <textarea id="contact-Subject"
                                                      class="form-control  @error('deleted_reason') is-invalid @enderror"
                                                      placeholder="دلیل حذف..." name="deleted_reason"
                                                      value="{{ old('deleted_reason')}}" rows="5"></textarea>
