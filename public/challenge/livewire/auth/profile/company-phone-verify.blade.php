                ...
                <div class="col-md-12 ">
                    ...
                    <div class="card ml-5" style="border-radius: 5px">
                        <div class="card-body " style="background-color: #fafafa;border-radius: 5px" dir="rtl">
                            ...
                            <!--Section heading-->
                            <!--Grid column-->
                            <form action="{{ route('profile.company.twofactor.phone.post') }}" method="POST" style="font-size: .8rem">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group text-right">
                                            <label for="exampleFormControlSelect2"> کد فعالسازی</label>
                                            <input type="text" id="exampleFormControlSelect2"
                                                   class="form-control  @error('token') is-invalid @enderror"
                                                   placeholder="کد فعالسازی ارسال شده را وارد نمایید..." name="token" value="{{ old('token')}}">
                                            @error('token')
