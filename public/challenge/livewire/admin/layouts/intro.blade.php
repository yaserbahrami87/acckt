            ...
            <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                ...
                <div class="card card-cascade cascading-admin-card">
                    ...
                    <div class="admin-up">
                        ...
                        <div class="data">
                            <p class="text-uppercase">دریافت کلی</p>
                            <h4 class="font-weight-bold dark-grey-text">200 mil</h4>
                        </div>
                    </div>
                    ...
                    <div class="card-body card-body-cascade">
                        ...
                        <p class="card-text text-right">رشد به نسبت هفته قبل (25%)</p>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                ...
                <div class="card card-cascade cascading-admin-card">
                    ...
                    <div class="admin-up">
                        ...
                        <div class="data">
                            <p class="text-uppercase">تعداد بازدید</p>
                    ...
                    <div class="card-body card-body-cascade">
                        ...
                        <p class="card-text text-right">رشد نسبت به هفته قبل (25%)</p>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-md-0 mb-4">
                ...
                <div class="card card-cascade cascading-admin-card">
                    ...
                    <div class="admin-up">
                        ...
                        <div class="data">
                            <p class="text-uppercase">مجموع ایده های تایید شده</p>
                    ...
                    <div class="card-body card-body-cascade">
                        ...
                        <p class="card-text text-right"> رشد نسبت به هفته گذشته (75%)</p>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-0">
                ...
                <div class="card card-cascade cascading-admin-card">
                    ...
                    <div class="admin-up">
                        ...
                        <div class="data">
                            <p class="text-uppercase">چالش های ثبت شده</p>
                    ...
                    <div class="card-body card-body-cascade">
                        ...
                        <p class="card-text text-right"> رشد نسبت به هفته گذشته (25%)</p>
                    </div>
