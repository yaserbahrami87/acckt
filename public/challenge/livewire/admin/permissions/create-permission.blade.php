...
@section('adminMain')
    ...
    <div>
        ...
        <div class="breadcrumb-dn font-weight-bold text-right  d-flex justify-content-end">
            <p class="mt-2 mr-2 ml-2" style="font-size: .8rem;font-weight: 500;color: #5472d3">ثبت دسترسی جدید</p>
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="card ml-5" style="border-radius: 5px">
                        <div class="card-body " style="background-color: #fafafa;border-radius: 5px">
                            ...
                            <!--Section heading-->
                            <!--Grid column-->
                            <form method="POST" action="{{route('create.backend.permission.post')}}"
                            ...
                            <!--Grid row-->
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group text-right">
                                            <label for="code">کد دسترسی</label>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group text-right">
                                            <label for="desc">توضیح دسترسی</label>
