...
@section('adminMain')
    ...
    <div>
        ...
        <div class="breadcrumb-dn font-weight-bold text-right  d-flex justify-content-end">
            <p class="mt-2 mr-2 ml-2" style="font-size: .8rem;font-weight: 500;color: #5472d3">ویرایش دسترسی</p>
            <i class="fas fa-chevron-left mr-3 ml-2 mt-2" style="margin-top: 1.5vh;color: #757575"></i>
            <p class="mt-2 mr-2" style="font-size: .8rem;font-weight: 500;color: #757575">دسترسی های شتابدهنده</p>
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="card ml-5" style="border-radius: 5px">
                        <div class="card-body " style="background-color: #fafafa;border-radius: 5px">
                            ...
                            <!--Section heading-->
                            <!--Grid column-->
                            <form method="POST" action="{{route('edit.backend.permission.post',$id)}}" style="font-size: .8rem">
                            ...
                            <!--Grid row-->
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group text-right">
                                            <label for="exampleFormControlSelect2">نام دسترسی</label>
                                            <input type="text" id="contact-Subject"
                                                   class="form-control  @error('name') is-invalid @enderror"
                                                   placeholder="نام دسترسی..." name="name" value="{{ old('name')}}"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group text-right">
                                            <label for="exampleFormControlSelect2">کد دسترسی</label>
                                            <input type="text" id="contact-Subject"
                                                   class="form-control  @error('code') is-invalid @enderror"
                                                   placeholder="کد دسترسی..." name="code" value="{{ old('code')}}"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group text-right">
                                            <label for="exampleFormControlSelect2">توضیح دسترسی</label>
                                            <input type="text" id="contact-Subject"
                                                   class="form-control  @error('label') is-invalid @enderror"
                                                   placeholder="توضیح دسترسی..." name="label" value="{{ old('label')}}"
