...
@section('adminMain')
    <div>
        ...
        <div class="breadcrumb-dn font-weight-bold text-right  d-flex justify-content-end">
            <p class="mt-2 mr-2 ml-2" style="font-size: .8rem;font-weight: 500;color: #5472d3">ویرایش چالش جدید</p>
            <i class="fas fa-chevron-left mr-3 ml-2 mt-2" style="margin-top: 1.5vh;color: #757575"></i>
            <p class="mt-2 mr-2" style="font-size: .8rem;font-weight: 500;color: #757575">چالش های شتابدهنده</p>
                ...
                <div class="col-md-12 " >
                    ...
                    <div class="card ml-5" style="border-radius: 5px">
                        <div class="card-body " style="background-color: #fafafa;border-radius: 5px">
                            ...
                            <!--Section heading-->
                            <!--Grid column-->
                            <form method="POST" action="{{route('admin.challenges.edit.post',$challenge->id)}}" style="font-size: .8rem" enctype="multipart/form-data">
                            ...
                            <!--Grid row-->
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group text-right">
                                            <label for="exampleFormControlSelect2">عنوان چالش</label>
                                            <input type="text" id="contact-Subject" class="form-control  @error('title') is-invalid @enderror" placeholder="عنوان چالش..." name="title" value="{{ old('title')}}">
                                            @error('title')
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group text-right">
                                            <label for="exampleFormControlSelect2">توضیحات چالش</label>
                                            <textarea id="challenge-editor" class="form-control  @error('desc') is-invalid @enderror" placeholder="توضیحات خبر را وارد کنید ... " name="desc" value="{{ old('desc')}}" rows="5"></textarea>
                                            @error('desc')
                                            <span class="invalid-feedback">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
    ...
    <script>
        CKEDITOR.replace('challenge-editor', {
