                        ...
                        @foreach($users as $user)
                            <tr class="text-center">
                                ...
                                <td class="d-flex justify-content-around">
                                    @can('approved_company_info')
                                        <form action="{{route('update.permissions.company.user',$user->id)}}"
                                              method="POST">
                                            @csrf
                                    ...
                                    @endcan
                                    @can('denay_company_info')
                                        <form action="{{route('delete.information.company.user',$user->id)}}"
                                              method="POST">
                                            @csrf
