            ...
            <div
                ...
                <div>
                    @can('create_backend_user')
                        <a href="{{route('create.backend.user')}}">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-hover mb-0 text-center" style="direction: rtl !important;">
                        ...
                        <tr>
                            ...
                            <th style="font-weight: bold;font-style: italic">نام خانوادگی</th>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 1.3rem">
                                    @can('add_user_permission')
                                        <a href="{{route('edit.permissions.backend.user',$user->id)}}"
                                           class="teal-text " data-toggle="tooltip" data-placement="bottom"
                                           title="دسترسی"><i id="action" class="fas fa-pencil-alt"></i></a>
                                    @endcan
                                    @can('add_user_role')
                                        <a href="{{route('edit.roles.backend.user',$user->id)}}" class="red-text"
                                           data-toggle="tooltip" data-placement="bottom" title="مقام"><i id="action"
                                                                                                         class="fas fa-times"></i></a>
                                    @endcan
                                    @can('edit_backend_user')
                                        <a href="{{route('edit.backend.user',$user->id)}}" class="red-text"
                                           data-toggle="tooltip" data-placement="bottom" title="ویرایش"><i id="action"
                                                                                                           class="fas fa-times"></i></a>
                                    @endcan
                                    @can('delete_backend_user')
                                        <a onclick="document.getElementById('delete_form').submit();" class="red-text"
                                           data-toggle="tooltip" data-placement="bottom" title="حذف"><i id="action"
                                                                                                        class="fas fa-times"></i></a>
                                        <form id="delete_form" action="{{route('delete.backend.user',$user->id)}}"
                                              method="POST">
                                            @csrf
                                        </form>
                                    @endcan
