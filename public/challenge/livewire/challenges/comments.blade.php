    ...
    <section class="mb-4 pt-5 wow fadeIn" data-wow-delay="0.3s">
        ...
        <div class="comments-list text-center text-md-left mb-5">
            <div class="text-center mb-4">
                 <h3 class="font-weight-bold pt-3 mb-5 text-dark "><span class="badge pink ">{{count($comments)}}</span> نظرات</h3>
            </div>
            ...
            <!--First row-->
                <div class="row mb-4 ml-3">
                    ...
                    <div class="col-2 mb-md-0 mb-3">
                        <img src="{{$comment->profile_image ?? asset('/images/451-4517876_default-profile-hd-png-download.jpg')}}" class="avatar rounded-circle z-depth-1-half">
                    </div>
                    <!--/.Image column-->
