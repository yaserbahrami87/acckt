        ...
        <div class="col-lg-9 d-flex justify-content-center">
            ...
            <div class=" col-12">
                ...
                <section class="pb-3 text-center text-md-right">
                    <!-- Grid row -->
                    <h3 id="challengesCard" class="section-heading text-center mr-5 mb-5 wow fadeIn text-light mx-auto" style="width: max-content"  data-wow-delay="0.2s" >اخبار شتابدهنده</h3>
