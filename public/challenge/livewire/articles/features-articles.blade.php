                                    ...
                                    <div class="carousel-caption">
                                        <div class="animated fadeInDown">
                                            <h4 class="h4-responsive">
                                                <a href="{{route('single.article',$article->slug)}}" class="white-text" style="text-decoration: none">{{$article->title}}</a>
                                            </h4>
                                        </div>
                                    </div>
                                    <!-- Caption -->
                            ...
                            <!-- Third slide -->
                                <div class="carousel-item">
                                    ...
                                    <div class="carousel-caption">
                                        <div class="animated fadeInDown">
                                            <h4 class="h4-responsive">
                                                <a href="{{route('single.article',$article->slug)}}" class="white-text">{{$article->title}}</a>
                                            </h4>
                                        </div>
                                    </div>
                                @else
