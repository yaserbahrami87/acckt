                                ...
                                <div class="col-lg-4 col-md-12 col-xs-12 mb-5" >
                                    ...
                                    <div class="card card-cascade narrower" id="articleCard" style="background-color: #ede7f6;min-height: 38vh;">
                                        ...
                                        <div class="card-body card-body-cascade ">
                                            ...
                                            <button class="navbardropdownedit" wire:click="like({{$article->id}})">
                                                <h6 class="red-text text-right"><i class="{{$article->like_process == true ? 'fas fa-heart'  : 'far fa-heart' }} float-right ml-2"></i>{{$article->main_category ?? ''}}</h6>
                                            </button>
                                            <!-- Title -->
