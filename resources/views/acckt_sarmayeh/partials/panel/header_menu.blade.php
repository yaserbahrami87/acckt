        ...
        <div class="navbar-container content">
            <div class="navbar-collapse" id="navbar-mobile">
                 <div class="col text-center d-none d-lg-block">
                    <h3>
                        <a href="/startup">
                            <img src="https://www.acckt.ir/themes/acckt/assets/img/logo_old.png" style="margin: 0 auto; width: 100px">
                            <span class="" style="font-family: Lalezar;">اندیشه خوارزم</span>
                        </a>
                    </h3>
                </div>
                ...
                <ul class="nav navbar-nav float-right">
                    ...
                    <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon bx bx-bell bx-tada bx-flip-horizontal"></i><span class="badge badge-pill badge-danger badge-up">0</span></a>
                        <ul class="dropdown-menu dropdown-menu-media">
                            <li class="dropdown-menu-header">
                                <div class="dropdown-header px-1 py-75 d-flex justify-content-between"><span class="notification-title">0 اعلان جدید</span><span class="text-bold-400 cursor-pointer">علامت خوانده شده به همه</span></div>
                            </li>
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                        ...
                        <div class="dropdown-menu pb-0">
                            <a class="dropdown-item" href="/portal"><i class="bx bx-user mr-50"></i> ویرایش پروفایل</a>
