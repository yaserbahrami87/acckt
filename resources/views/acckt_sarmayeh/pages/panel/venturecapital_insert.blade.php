                                            ...
                                            <div class="card-body">
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                                        ...
                                                        @endif
                                                            <form class="wizard-validation" method="POST" action="/portal/venturecapital" id="new_wizard_form"  data-request-validate>
                                                                {{csrf_field()}}
                                                                <h6>
                                                                    <i class="step-icon"></i>
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                                    <input type="radio" id="investmentIndex1" name="venturecapital_id" class="custom-control-input" value="1"  {{ old('venturecapital_id') == 1 ? 'checked' : '' }} />
                                                                                ...
                                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                                    <input type="radio" id="investmentIndex2" name="venturecapital_id" class="custom-control-input" value="2" {{ old('venturecapital_id') == 2 ? 'checked' : '' }} />
                                                                                ...
                                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                                    <input type="radio" id="investmentIndex3" name="venturecapital_id" class="custom-control-input" value="3" {{ old('venturecapital_id') == 3 ? 'checked' : '' }}  />
                                                                                ...
                                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                                    <input type="radio" id="investmentIndex4" name="venturecapital_id" class="custom-control-input" value="4" {{ old('venturecapital_id') == 4 ? 'checked' : '' }}  />
