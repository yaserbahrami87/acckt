                                                        ...
                                                        <form  id="new_wizard_form"  data-request-validate class="wizard-validation" method="POST" action="/portal/amountcapital" enctype="multipart/form-data">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="capitalgroup_id">با توجه به گروه های تخصصی شتابدهنده اندیشه خوارزم علاقه شما به سرمایه گذاری در کدام گروه قرار می گیرد؟ <span class="text-danger">*</span> </label>
                                                                            <select class="form-control" id="capitalgroup_id" name="capitalgroup_id" required>
                                                                                <option selected disabled>انتخاب کنید</option>
                                                                                <option value="1" {{ old('capitalgroup_id') == 1 ? 'selected' : '' }}>تجارت الکترونیک</option>
                                                                                <option value="2" {{ old('capitalgroup_id') == 2 ? 'selected' : '' }}>سلامت</option>
                                                                                <option value="3" {{ old('capitalgroup_id') == 3 ? 'selected' : '' }}>گردشگری</option>
                                                                                <option value="3" {{ old('capitalgroup_id') == 4 ? 'selected' : '' }}>مرتبط با IT</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <label for="capitalcategory_id">سرمایه گذاری شما در کدام دسته بندی موضوعی خواهد بود؟ <span class="text-danger">*</span> </label>
                                                                            <select class="form-control" id="capitalcategory_id" name="capitalcategory_id" required>
                                                                                <option selected disabled>انتخاب کنید</option>
                                                                                <option value="1" {{ old('capitalcategory_id') == 1 ? 'selected' : '' }}>کاملا جدید</option>
                                                                                <option value="2" {{ old('capitalcategory_id') == 2 ? 'selected' : '' }}>بازتولید با نگاه نوآورانه</option>
                                                                                <option value="3" {{ old('capitalcategory_id') == 3 ? 'selected' : '' }}>مهندسی معکوس</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <fieldset>
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="trl">تزریق سرمایه مطابق با سطع آمادگی فناوری (<a href="" data-toggle="modal" data-target="#TRLModal">معیار های TRL</a>): <span class="text-danger">*</span></label>
                                                                            <!-- Modal -->
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="amountcapitals">میزان سرمایه ای که تمایل دارید برای یک کسب و کار نو سرمایه گذاری کنید چقدر است؟ <span class="text-danger">*</span></label>
                                                                            <select class="form-control" id="amountcapitals" name="amountcapitals_id" required>
                                                                                <option selected disabled>انتخاب کنید</option>
                                                                                <option {{ old('amountcapitals_id') == 1 ? 'selected' : '' }} value="1">کمتر از 500 میلیون تومان </option>
                                                                                <option {{ old('amountcapitals_id') == 2 ? 'selected' : '' }} value="2">کمتر از 1 میلیارد تومان </option>
                                                                                <option {{ old('amountcapitals_id') == 3 ? 'selected' : '' }} value="3">بین یک تا دو میلیارد تومان</option>
                                                                                <option {{ old('amountcapitals_id') == 4 ? 'selected' : '' }} value="4">بیش از دو میلیارد تومان</option>
                                                                            </select>
                                                            ...
                                                            <fieldset>
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="description">شرح انتظارات سرمایه گذاری:<span class="text-danger">*</span> </label>
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label for="injectioncapital_id">سرمایه مدنظر برای تزریق به چه صورت است؟<span class="text-danger">*</span> </label>
                                                                            <select class="form-control" id="injectioncapital_id" name="injectioncapital_id" required>
                                                                                <option selected disabled>انتخاب کنید</option>
                                                                                <option value="1" {{ old('injectioncapital_id') == 1 ? 'selected' : '' }}>نقدی</option>
                                                                                <option value="2" {{ old('injectioncapital_id') == 2 ? 'selected' : '' }}>اعتباری</option>
                                                                                <option value="3" {{ old('injectioncapital_id') == 3 ? 'selected' : '' }}>امکانات و تجهیزات</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
