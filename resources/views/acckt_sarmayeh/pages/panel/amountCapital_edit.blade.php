                                            ...
                                            <div class="card-body">
                                                <div class="tab-content">
                                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general" aria-labelledby="account-pill-general" aria-expanded="true">
                                                        ...
                                                        @endif
                                                        <form class="row" method="POST" action="/portal/amountcapital/{{$amountcapital->id}}" >
                                                            {{csrf_field()}}
                                                            {{method_field('PATCH')}}
                                                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control" id="amountcapitals" name="amountcapitals_id">
                                                                        ...
                                                                        <option @if($amountcapital->amountcapitals_id==1) selected @endif value="1">کمتر از یک میلیارد تومان</option>
                                                                        <option @if($amountcapital->amountcapitals_id==2) selected @endif value="2">بین یک تا دو میلیارد تومان</option>
                                                                        <option @if($amountcapital->amountcapitals_id==3) selected @endif value="3">بیش از دو میلیارد تومان</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
