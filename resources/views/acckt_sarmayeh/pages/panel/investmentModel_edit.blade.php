                                                            ...
                                                            <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="custom-control custom-radio custom-control-inline">
                                                                        <input type="radio" id="investmentIndex1" name="investmentmodel_id" class="custom-control-input" value="1"  @if($investmentModel->investmentmodel_id==1) checked @endif />
                                                                        <label class="custom-control-label" for="investmentIndex1">بلی</label>
                                                                    </div>
                                                                    <div class="custom-control custom-radio custom-control-inline">
                                                                        <input type="radio" id="investmentIndex2" name="investmentmodel_id" class="custom-control-input" value="0"  @if($investmentModel->investmentmodel_id==0) checked @endif/>
